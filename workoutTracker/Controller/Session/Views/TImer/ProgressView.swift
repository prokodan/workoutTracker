...
extension TimerView {
    final class ProgressView: UIView {
        ...
        func drawProgress(with value: CGFloat) {
            ...
            bottomLayer.path = circlePath.cgPath
            bottomLayer.strokeColor = R.Colors.separatorColor.cgColor
            bottomLayer.lineWidth = 20
            ...
            let dotAngle = CGFloat.pi * ( 7 / 6 - ( 8 / 6 * value ))
            ...
            (1...9).forEach { _ in
                ...
                barLayer.strokeColor = angle >= ( 7 / 6 - ( 8 / 6 * value )) ? R.Colors.active.cgColor : R.Colors.separatorColor.cgColor
